...
<script>
  import {
    ...
    search_songlrc_data} from "./search_page_data";
    ...
    methods: {
      ...
      async pageDataInit(type){
        switch (type) {
          ...
          case '1004':
            break;
          case '1006':
            this.search_songlrc_data = this.$deepClone(search_songlrc_data);
      ...
      searchResultInit(data){
        if(this.search_type == '1'){
          ...
          // this.pageData.total = this.search_songlist_data.data.t_page.total = data.result.songCount;
        }
      },
