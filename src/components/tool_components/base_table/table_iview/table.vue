<template>
  <div :class="wrapClasses" :style="styles">
    <div :class="classes">
      ...
      <div :class="[prefixCls + '-body']" style="overflow: hidden!important;" :style="bodyStyle" ref="body" @scroll="handleBodyScroll"
        ...
        <table-body
          ...
          :columns-width="columnsWidth"
          :obj-data="objData">
          <template v-for="(slot_item, slot_index) in cloneColumns"
               v-if="slot_item.table_slot"
               :slot="slot_item.table_slot" slot-scope="rowData">
            <slot :name="slot_item.table_slot" :rowData="rowData.rowData"></slot>
          </template>
        </table-body>
      </div>
      <div
