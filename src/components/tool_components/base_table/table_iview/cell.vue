  ...
  <div :class="classes" ref="cell" v-if="!column.noshow">
    ...
    <template v-if="renderType === 'normal'">
      <template v-if="column.tooltip">
        <Tooltip transfer :content="row[column.key]" :disabled="!showTooltip" :max-width="200" class="ivu-table-cell-tooltip">
    ...
    <template v-if="renderType === 'table_slot'">
      <slot :name="column.table_slot" :rowData="row"></slot>
    </template>
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      }else if (this.column.type === 'operate') {
        this.renderType = 'operate';
      } else if (this.column.table_slot) {
        this.renderType = 'table_slot';
